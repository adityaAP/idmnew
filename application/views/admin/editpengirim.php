                  ...
                  <div class="tab-body">
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">   
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="nama_pabrik" class="form-control" value="<?=isset($pengiriman)?$this->kode_converter->vendor($pengiriman['id_vendor']):'';?>" readonly>
                        </div>
                      </div>                       
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="tgl_muat" class="form-control inputmask" value="<?=isset($pengiriman)?date('d-m-Y',strtotime($pengiriman['tgl_muat'])):'';?>" >
                        </div>
                      </div>
                        <div class="form-group row">
