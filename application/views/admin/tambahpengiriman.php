          ...
          <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Tambah Pengiriman Intan Daya Mandiri</h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                        ...
                        <div class="col-sm-4">
                          <select class="form-control" name="nama_pabrik">
                            ...
                            <?php if ($cust!='') { foreach ($cust as $value) { ?>
                              <option <?=isset($pengiriman)&&$pengiriman['id_customer']==$value['id_cust']?"selected":''; ?> value="<?=$value['id_cust']?>"><?=$value['nama_cust']?></option>
                            <?php }} ?>
                          </select>
                        </div>
