			<div role="main" class="main">
				...
				<section class="page-header page-header-modern page-header-background page-header-background-md overlay overlay-color-dark overlay-show overlay-op-9" style="background-image: url(<?=base_url('assets/home/')?>img/page-header/page-header-about-us.jpg);padding:50px 0px;background-color:#13233d; ">
					<div class="container">
						<div class="row">
				...
				<div class="container pb-1" style="margin-bottom:150px;">
